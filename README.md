...
09/11/2018 — Updated "Dig-theme.xml" file to 1.8.19
08/28/2018 — Updated "Dig-theme.xml" file to 1.8.18
04/13/2016 — Updated "Dig-theme.xml" file to 1.8.7 from 1.4.x

To Do:
* clean up any minor styling issues
* improve theme if and when  my time allows
